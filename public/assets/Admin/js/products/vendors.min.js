...
!(function (e, t) {
    ...
    function be(e, t, n, i, o) {
        ...
        for (p.textContent = "", h = 0; (r = f[h++]); )
            ...
            else if (((c = oe(r)), (a = ye(p.appendChild(r), "script")), c && me(a), n)) for (u = 0; (r = a[u++]); ) de.test(r.type || "") && n.push(r);
        return p;
    }
    var xe = /^key/,
                            ...
                            return function () {
                                ...
                                ((n = i = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null),
                                    "abort" === e
                                        ...
                                        : r(Ut[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? { binary: s.response } : { text: s.responseText }, s.getAllResponseHeaders()));
                            };
                        }),
                            (s.onload = n()),
            ...
            ((O = function (e) {
                ...
                w = function () {
                    ...
                    for (t = arguments[0], r = 0, a = (i = 2 <= arguments.length ? $.call(arguments, 1) : []).length; a > r; r++)
                        if ((n = i[r])) for (e in n) Q.call(n, e) && ((o = n[e]), null != t[e] && "object" == typeof t[e] && null != o && "object" == typeof o ? w(t[e], o) : (t[e] = o));
                    return t;
                },
                y = function (e) {
                    var t, n, i, o, r;
                ...
                function t() {
                    ...
                    if (null != q && L.ajax.trackWebSockets) {
                        window.WebSocket = function (e, t) {
                            var i;
                            return (i = null != t ? new q(e, t) : new q(e)), I("socket") && n.trigger("request", { type: "socket", url: e, protocols: t, request: i }), i;
                        };
                        try {
            ...
            function (e, t, n) {
                ...
                e.exports = function (e) {
                    var t,
                        ...
                        m = 0,
                        v = c(f);
                    if ((y && (g = i(g, d > 2 ? arguments[2] : void 0, 2)), null == v || (h == Array && a(v)))) for (n = new h((t = s(f.length))); t > m; m++) l(n, m, y ? g(f[m], m) : f[m]);
