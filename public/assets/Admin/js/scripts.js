...
$(function () {
  var t,
      ...
      M = "../../../app-assets/";
  if ("laravel" === $("body").attr("data-framework") && (M = $("body").attr("data-asset-path")), $.app.menu.is_touch_device()) f.css("overflow", "scroll"), y.css("overflow", "scroll");else {
    if (f.length > 0) new PerfectScrollbar(f[0], {
      theme: "dark"
    });
    if (y.length > 0) new PerfectScrollbar(y[0], {
      theme: "dark"
    });
  }
  x.length && x.find("a").on("click", function () {
    x.find("a").hasClass("active") && x.find("a").removeClass("active"), $(this).addClass("active");
  });
  var S = document.getElementById("todo-task-list");

  function q(t) {
    return t.id ? '<div class="media align-items-center"><img class="d-block rounded-circle mr-50" src="' + $(t.element).data("img") + '" height="26" width="26" alt="' + t.text + '"><div class="media-body"><p class="mb-0">' + t.text + "</p></div></div>" : t.text;
  }

  if (void 0 !== _typeof(S) && null !== S && dragula([S], {
    moves: function moves(t, e, o) {
      return o.classList.contains("drag-icon");
    }
  }), u.length && u.on("click", function (t) {
    g.removeClass("show"), p.removeClass("show");
  }), v.length && v.on("click", function (t) {
    t.stopPropagation(), g.toggleClass("show"), p.addClass("show");
  }), p.length && p.on("click", function (t) {
    g.removeClass("show"), p.removeClass("show"), $(o).modal("hide");
  }), m.length && (m.wrap('<div class="position-relative"></div>'), m.select2({
  ...
  })), h.length && (h.wrap('<div class="position-relative"></div>'), h.select2({
    ...
    dateFormat: "Y-m-d",
    defaultDate: "today",
    onReady: function onReady(t, e, o) {
      o.isMobile && $(o.mobileInput).attr("step", null);
    }
  }), c.length) new Quill("#task-desc", {
    bounds: "#task-desc",
    modules: {
      formula: !0,
      syntax: !0,
  ...
  n.length && n.on("click", function (t) {
    l.removeClass("d-none"), r.addClass("d-none"), i.text("Add Task"), g.removeClass("show"), p.removeClass("show"), o.find(".new-todo-item-title").val(""), c.find(".ql-editor")[0].innerHTML = "";
  }), a.length && (a.validate({
    ignore: ".ql-container *",
    rules: {
      todoTitleAdd: {
    ...
    if (t.preventDefault(), a.valid()) {
      ...
      var e = $("#task-assigned").val(),
        ...
        month: "short"
      }).format(d) + " " + new Intl.DateTimeFormat("en", {
        day: "2-digit"
      }).format(d),
          c = $(".task-tag").val(),
          m = {
      ...
      }), "" != l && $(C).prepend('<li class="todo-item"><div class="todo-title-wrapper"><div class="todo-title-area">' + feather.icons["more-vertical"].toSvg({
        "class": "drag-icon"
      }) + '<div class="title-wrapper"><div class="custom-control custom-checkbox"><input type="checkbox" class="custom-control-input" id="customCheck' + D + '" /><label class="custom-control-label" for="customCheck' + D + '"></label></div><span class="todo-title">' + l + '</span></div></div><div class="todo-item-action"><div class="badge-wrapper mr-1">' + s + '</div><small class="text-nowrap text-muted mr-1">' + r + '</small><div class="avatar"><img src="' + i[e] + '" alt="' + e + '" height="28" width="28"></div></div></div></li>'), toastr.success("Data Saved", "💾 Task Action!", {
        closeButton: !0,
        tapToDismiss: !1,
        rtl: j
      }), $(o).modal("hide"), p.removeClass("show");
    }
  })), y.on("change", ".custom-checkbox", function (t) {
    var e = $(this).find("input");
    e.prop("checked") ? (e.closest(".todo-item").addClass("completed"), toastr.success("Task Completed", "Congratulations!! 🎉", {
      closeButton: !0,
      tapToDismiss: !1,
      rtl: j
    ...
    if (e.preventDefault(), s) {
      ...
      $(t).text(i), toastr.success("Data Saved", "💾 Task Action!", {
        closeButton: !0,
        tapToDismiss: !1,
        rtl: j
      }), $(o).modal("hide");
  ...
  }), w.length && w.on("keyup", function () {
    var t = $(this).val().toLowerCase();
    "" !== t ? ($(".todo-item").filter(function () {
      $(this).toggle($(this).text().toLowerCase().indexOf(t) > -1);
    }), 0 == $(".todo-item:visible").length ? $(T).hasClass("show") || $(T).addClass("show") : $(T).removeClass("show")) : ($(".todo-item").show(), $(T).hasClass("show") && $(T).removeClass("show"));
...
window.colors = {
  ...
  if ("laravel" === t("body").attr("data-framework") && (r = t("body").attr("data-asset-path")), t.fn.dataTable && t.extend(t.fn.dataTable.ext.classes, {
    ...
    t(".custom-file-input").on("change", function (a) {
      ...
      var a = t(".search-input-test-close").closest(".search-input-test");
  ...
  var p = t(".search-input-test input").data("search"),
      v = t(".bookmark-wrapper"),
      g = t(".bookmark-wrapper .bookmark-star"),
      b = t(".bookmark-wrapper .bookmark-input"),
      C = t(".nav-link-search"),
      k = t(".search-input-test"),
      w = t(".search-input-test input"),
  ...
  if (g.on("click", function (a) {
    ...
    t(this);
    t(this).parent(".nav-search").find(".search-input-test").addClass("open"), w.focus(), y.find("li").remove(), b.removeClass("show");
  }), t(".search-input-test-close").on("click", function () {
    t(this);
    var a = t(this).closest(".search-input-test");
...
/******/ 	__webpack_require__("./resources/js/libs/customizer.min.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/libs/app-todo.min.js");
/******/ 	
/******/ })()
;